    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Row(
            ...
            Text(
                ...
                text = "为" + mainUiState.chosenDate.year.toString() + "年" +
                        mainUiState.chosenDate.monthValue.toString() + "月" +
                        mainUiState.chosenDate.dayOfMonth.toString() + "日" +
                        if(mainUiState.chosenDate == mainUiState.nowDate) "（今日）" else "" +
                        "\n" + "添加一项新记录",
        ...
        Column(
            ...
            Column(
                ...
                Row(
                    ...
                    Button(
                        onClick = {
                            navController.navigate("MANAGE_RECORD_TYPE_SCREEN")
                        }
                    ) {
                        Text("管理类型")
                    }
